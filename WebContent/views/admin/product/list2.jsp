...
<link href="/resources/css/admin/product/list.css" rel="stylesheet"
	type="text/css" />
...
<body>
	<%
		ArrayList<ProductAll> allList = (ArrayList<ProductAll>) request.getAttribute("productList");
		ArrayList<ProductAll> selectList = (ArrayList<ProductAll>) request.getAttribute("productSelectList");
	%>
			...
			<div id="contents_box">
				...
				<form action="/searchProduct.kh" method="post">
					<div id="basicInfo">
						...
						<table cellspacing="0" cellpadding="0" width=100%;>
							...
							<tr>
								<th>상품등록일</th>
								<td colspan="2"><input type="date" name="startDate"
									id="starDate" min="2000-01-01" max="2100-12-31" /> ~ <input
									type="date" name="endDate" id="lastDate" min="2000-01-01"
									max="2100-12-31" /></td>
							</tr>
						...
						<div>
							...
							<button type="button" class="searchBtn" onclick="location.href =  '/productAllList.kh';">초기화</button>												
						</div>
					</div>
				</form>
				<script>
				...
				<div id="basicInfo">
					...
					<table cellspacing="0" cellpadding="0" width=100%;>
						...
						<%
							ArrayList<ProductAll> list = null;
							if (allList != null) {
								list = allList;
							} else {
								list = selectList;
							...
							<tr>
								...
								<td>
									<div class="productImg">
										<img src="/resources/images/product/<%=productAll.getImg().getChangedName()%>"
