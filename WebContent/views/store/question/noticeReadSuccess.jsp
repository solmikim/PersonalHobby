...
<html>
<head>
<link href="/resources/css/store/question/noticepostReadSuccess.css" rel="stylesheet" type="text/css">
...
<div id="contents">
		<div id="board">
				...
				<%}else if(0<=mAll.getM().getMemberNo() && mAll.getM().getMemberNo()<=100){ %>
					...
					<form action="/noticeModifyPage.kh" method="post" style="float:left " >               		
							...
							<div class="comment-wrapper">
								...
								<div id="btn-wrapper">
									...
									<form action="/answerModify.kh" method="post"
										...
										<button type="button" class="answerModifyBtn">수정</button>
									...
									<form action="/answerDelete.kh" method="post"
										style="display: inline">
										<button type="button" class="answerDeleteBtn">삭제</button>
										<input type="hidden" name="boardNo" value="<%=board.getboardNo()%>" />
										<input type="hidden" name="boardCategoryName" value="<%=board.getboardCategoryName()%>" />
									</form>
								</div>
