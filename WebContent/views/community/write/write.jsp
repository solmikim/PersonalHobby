					...
					<h1>커뮤니티</h1>
						...
						<div>
							<input type="text" name="keyword" placeholder="상품명을 검색하세요."
								...
								class="submit" value="검색" id="searchBtn" />

						</div>
						<br>
						<div>
							선택한 상품번호 : <input type="text" name="selectProduct"id="selectProduct" />
							 &nbsp; 선택한 상품명 : <input type="text" name="selectName" id="selectName"/>
						</div>
						<br>
						<form action="/communityWrite.kh" id="articleForm" method="post"
							enctype="multipart/form-data">


							<div id="fileimg">
								<input type="file" name="file" id="file" /> <input
									type="hidden" id="searchProduct" name="productNo" />
							</div>
							...
							<div class="form-group">
								<textarea id="summernote" name="content"
									placeholder="내용을 입력해주세요." maxlength="140" rows="10"></textarea>
							</div>
								<div class="hashtag-section">
						<div>
							<input type="text" id="inputText" name="inputText" placeholder="태그를 입력하세요"/>
						</div>
						<button id="plusBtn" type="button">
							...
							<div class="button-group">
								<button class="submit" name="tagChoice" id="tagChoice" style="width:300px; margin-bottom: 50px;">확인</button>
								<button type="submit" class="submit" name="submit" style="width:300px;">취소</button>
							</div>
						</form>
			</div>
